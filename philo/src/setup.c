...
/*   Updated: 2022/10/31 21:40:17 by bmugnol-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_config	*get_config(int argc, char **argv)
{
	...
	config->time_to_die_usec = (long)(ft_atoi(argv[2])) * MILLI_TO_MICRO;
	config->time_to_eat_usec = (long)(ft_atoi(argv[3])) * MILLI_TO_MICRO;
	config->time_to_sleep_usec = (long)(ft_atoi(argv[4])) * MILLI_TO_MICRO;
	if (argv[4])
